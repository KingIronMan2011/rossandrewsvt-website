    ...
    >
      ...
      <div className="relative z-50">
        ...
        <main className="relative z-0 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-14">
          <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-lg rounded-2xl shadow-xl p-6 md:p-10 transition-all duration-300 hover:shadow-2xl border border-gray-100 dark:border-gray-700">
