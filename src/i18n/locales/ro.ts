export const ro = {
  translation: {
    ...
    artistDescriptions: {
      ...
      banners: "Bannere și overlay-uri Twitch & X",
      ytBanner: "Banner YouTube, logo și overlay BRB",
      emotes: "Emote-uri, banner și logo Discord",
      model3d: "Model 3D",
      loreAnim: "Animație lore video",
      loreVoice: "Voce pentru lore video",
      badges: "Insigne de abonat",
      emotesBadges: "Emote-uri, banner Discord, logo și insigne de abonat",
